<template>
    ...
    <AuthenticatedLayout>
        ...
        <form @submit.prevent="updatePartener">
            <div>
...
const form = useForm({
    name: props.partener.name,
    email: props.partener.email,
    phone_number: props.partener.phone_number,
    numero_siret: props.partener.numero_siret
});

const updatePartener = () => {
    form.put(route('parteners.update', props.partener.id), {
